...
'''
# Uncomment the following code to create a Series object
...
# Uncomment the following lines of code to see custom index in action
...
'''
# Uncomment the following lines of code to see Series indexing in action
# series = pd.Series(['Dave', 'Cheng-Han', 359, 9001],
#                    index=['Instructor', 'Curriculum Manager',
#                           'Course Number', 'Power Level'])
...
'''
# Uncomment the following lines of code to see boolean indexing in action
